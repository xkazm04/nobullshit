...
const HabitSelection = () => {
    ...
    return <div className="flex flex-col justify-start full-w">
            <div className="flex flex-row justify-start gap-3 font-mono text-main text-sm"> 
            <div className={`${custom ? ' ' : 'bg-blue-950/50'} px-3 py-1 rounded-2xl transition-all duration-300 lg:cursor-pointer`}  
